...
\begin{document}
    ...
    \midskip
    This led to some improvements in the memory usage which now maxes around 1300MB. Its time efficiency also increased reaching 3100 in 10 seconds.
